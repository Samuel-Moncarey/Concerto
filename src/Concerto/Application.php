...
use Concerto\EventListener\LocaleListener;
use Concerto\EventListener\MiddlewareListener;
use Concerto\EventListener\ConverterListener;
use Concerto\EventListener\StringToResponseListener;

/**
 * The Concerto framework class.
 *
...
class Application extends \Pimple implements HttpKernelInterface, TerminableInterface
{
    ...
    public function __construct(array $values = array())
    {
        ...
        $this['route_class'] = 'Concerto\\Route';
