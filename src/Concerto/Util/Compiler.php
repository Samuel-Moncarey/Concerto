...
/**
 * The Compiler class compiles the Concerto framework.
 *
...
class Compiler
{
    ...
    /**
     * Compiles the Concerto source code into one single Phar file.
     *
     * @param string $pharFile Name of the output Phar file
     */
    public function compile($pharFile = 'concerto.phar')
    {
        ...
        $phar = new \Phar($pharFile, 0, 'concerto.phar');
...
Phar::mapPhar('concerto.phar');

require_once 'phar://concerto.phar/vendor/autoload.php';
